            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function animateCSS(a, b, c, d) {
                        var e;
                        Array.isArray(b) || (b = [b]),
                            (e = a.classList).add.apply(
                                e,
                                ["animated"].concat(_toConsumableArray(b))
                            );
                        var f = function () {
                            var c;
                            (c = a.classList).remove.apply(
                                c,
                                ["animated"].concat(_toConsumableArray(b))
                            ),
            ...
            _createClass(a, [
                {
                    ...
                    value: function initSVGIcon() {
                        this.util.forEach(
                            ...
                            function (a) {
                                fetch(a.getAttribute("data-svg-src"))
                                    .then(function (a) {
                                        return a.text();
                                    })
                                    .then(function (b) {
                ...
                },
                {
                    ...
                    value: function initSearch() {
                        ...
                        if (
                            !(
                                !b ||
                                (c && this._searchMobileOnce) ||
                                (!c && this._searchDesktopOnce)
                            )
                        ) {
                            var d = b.maxResultLength ? b.maxResultLength : 10,
                                ...
                                i = document.getElementById(
                                    "search-input-".concat(g)
                                ),
                                j = document.getElementById(
                                    "search-toggle-".concat(g)
                                ),
                                k = document.getElementById(
                                    "search-loading-".concat(g)
                                ),
                                l = document.getElementById(
                                    "search-clear-".concat(g)
                                );
                            c
                                      ...
                                      .addEventListener(
                                          ...
                                          function () {
                                              h.classList.remove("open"),
                                                  ...
                                                  a._searchMobile &&
                                                      a._searchMobile.autocomplete.setVal(
                                                          ""
                                                      );
                                          },
                                          !1
                                ...
                                : ((this._searchDesktopOnce = !0),
                                  ...
                                  l.addEventListener(
                                      ...
                                      function () {
                                          (l.style.display = "none"),
                                              a._searchDesktop &&
                                                  a._searchDesktop.autocomplete.setVal(
                                                      ""
                                                  );
                                      },
                                      !1
                                        ...
                                        templates: {
                                            suggestion: function suggestion(a) {
                                                ...
                                                return '<div><span class="suggestion-title">'
                                                    .concat(
                                                        b,
                                                        '</span><span class="suggestion-date">'
                                                    )
                                                    .concat(
                                                        c,
                    ...
                    value: function initHighlight() {
                        ...
                        this.util.forEach(
                            ...
                            this.util.forEach(
                                ...
                                function (b) {
                                    var c =
                                        b.querySelectorAll("pre.chroma > code");
                                    if (c.length) {
                                        var d = c[c.length - 1],
                                        ...
                                        h.insertAdjacentHTML(
                                            ...
                                            h.classList.add("copy");
                                        var i = d.innerText;
                                        if (
                                            ((0 > a.config.code.maxShownLines ||
                                                i.split("\n").length <
                                                    a.config.code
                                                        .maxShownLines +
                                                        2) &&
                                                b.classList.add("open"),
                                            a.config.code.copyTitle)
                                        ) {
                                            h.setAttribute(
                                                "data-clipboard-text",
                                                i
                        ...
                        if (null !== b)
                            if (
                                ...
                                b.parentElement !== o &&
                                    ...
                                    o.appendChild(b)),
                                    this._tocOnScroll &&
                                        this.scrollEventSet.delete(
                                            this._tocOnScroll
                                        );
                            } else {
                                var p =
                                    document.getElementById("toc-content-auto");
                                b.parentElement !== p &&
                                    (b.parentElement.removeChild(b),
                                    p.appendChild(b));
                                ...
                                (c.style.left = "".concat(
                                    ...
                                    (c.style.maxWidth = "".concat(
                                        d.getBoundingClientRect().left - 20,
                                        "px"
                                    )),
                                ...
                                (this._tocOnScroll =
                                    ...
                                    function () {
                                        ...
                                        if (-1 !== q) {
                                            ...
                                            for (
                                                var u = f[q].parentElement;
                                                u !== b;

                                            )
                                                u.classList.add("has-active"),
                                                    (u =
                                                        u.parentElement
                                                            .parentElement);
                                        }
                    ...
                    value: function initEcharts() {
                        ...
                        (this._echartsOnSwitchTheme =
                            ...
                            function () {
                                ...
                                for (var b = 0; b < a._echartsArr.length; b++)
                                    a._echartsArr[b].dispose();
                                (a._echartsArr = []),
                                    a.util.forEach(
                                        document.getElementsByClassName(
                                            "echarts"
                                        ...
                                        function (b) {
                                            var c = echarts.init(
                                                b,
                                                a.isDark ? "dark" : "macarons",
                                                { renderer: "svg" }
                                            );
                                            c.setOption(
                                                JSON.parse(a.data[b.id])
                                            ),
                                                a._echartsArr.push(c);
                                        }
                                    );
                            }),
                            ...
                            (this._echartsOnResize =
                                ...
                                function () {
                                    for (
                                        var b = 0;
                                        b < a._echartsArr.length;
                                        b++
                                    )
                                        a._echartsArr[b].resize();
                                }),
                    ...
                    value: function initMapbox() {
                        ...
                        this.config.mapbox &&
                            ((mapboxgl.accessToken =
                                this.config.mapbox.accessToken),
                            mapboxgl.setRTLTextPlugin(
                                this.config.mapbox.RTLTextPlugin
                            ),
                            ...
                            this.util.forEach(
                                ...
                                function (b) {
                                    ...
                                    i &&
                                        ...
                                        n.addControl(new MapboxLanguage()),
                                        a._mapboxArr.push(n);
                                }
                            ),
                                ...
                                function () {
                                    a.util.forEach(a._mapboxArr, function (b) {
                                        var c = b.getContainer(),
                                            ...
                                            e = d.lightStyle,
                                            f = d.darkStyle;
                                        b.setStyle(a.isDark ? f : e),
                                            b.addControl(new MapboxLanguage());
                                    });
                                }),
                            this.switchThemeEventSet.add(
                                this._mapboxOnSwitchTheme
                    ...
                    value: function initComment() {
                        ...
                        if (this.config.comment) {
                            if (this.config.comment.gitalk) {
                                this.config.comment.gitalk.body = decodeURI(
                            ...
                            if (
                                (this.config.comment.valine &&
                                    new Valine(this.config.comment.valine),
                                this.config.comment.utterances)
                            ) {
                                var b = this.config.comment.utterances,
                                    c = document.createElement("script");
                                (c.src = "https://utteranc.es/client.js"),
                                    (c.type = "text/javascript"),
                                    c.setAttribute("repo", b.repo),
                                    c.setAttribute("issue-term", b.issueTerm),
                                    b.label && c.setAttribute("label", b.label),
                                    c.setAttribute(
                                        "theme",
                                        this.isDark ? b.darkTheme : b.lightTheme
                                    ),
                                    (c.crossOrigin = "anonymous"),
                                    (c.async = !0),
                                    document
                                        .getElementById("utterances")
                                        .appendChild(c),
                ...
                },
                {
                    ...
                    value: function onScroll() {
                        ...
                        if (
                            ("auto" ===
                                document.body.getAttribute("header-desktop") &&
                                b.push(
                                    document.getElementById("header-desktop")
                                ),
                            "auto" ===
                                document.body.getAttribute("header-mobile") &&
                                b.push(
                ...
                },
                {
                    ...
                    value: function onResize() {
                        ...
                        window.addEventListener(
                            ...
                            function () {
                                a._resizeTimeout ||
                                    (a._resizeTimeout = window.setTimeout(
                                        function () {
