    ...
    })(
        {
                    ...
                    if (
                        ...
                        o.on(m, function (t, e) {
                            ...
                            o.on(w, function (t, e) {
                                var n = t[0];
                                n instanceof g &&
                                    i("bst", [n, e, this.bstStart, Date.now()]);
                            }),
            ...
            9: [
                function (t, e, n) {
                    ...
                    if (
                        ...
                        d.inPlace(y.prototype, ["open", "send"], "-xhr-", s),
                        ...
                        if (!this.ended) {
                            ...
                            if (!e.aborted) {
                                if (
                                    ...
                                    if (
                                        (i && (n.rxSize = i), this.sameOrigin)
                                    ) {
                                        var a = t.getResponseHeader(
                                            "X-NewRelic-App-Data"
                                        );
                                        a && (e.cat = a.split(", ").pop());
                                    }
            ...
            12: [
                function (t, e, n) {
                    ...
                    function o(t, e, n) {
                        return function () {
                            return (
                                i(
                                    t,
                                    [new Date().getTime()].concat(s(arguments)),
                                    e ? null : this,
                                    n
                                ),
                                e ? void 0 : this
                    ...
                    a(u, function (t, e) {
                        ...
                        (f.addPageAction = o(d + "addPageAction", !0)),
                        (e.exports = newrelic),
                ...
                function (t, e, n) {
                    ...
                    function o(t) {
                        ...
                        function n(n, r, o) {
                            t && t(n, r, o);
                            for (
                                var i = e(o), a = l(n), s = a.length, c = 0;
                                c < s;
                                c++
                            )
                                a[c].apply(i, r);
            ...
            loader: [
                function (t, e, n) {
                    function r() {
                        if (!g++) {
                            ...
                            if (t && t.licenseKey && t.applicationID && e) {
                                ...
                                var n =
                                    "https" === m.split(":")[0] || t.sslForHttp;
                                (y.proto = n ? "https://" : "http://"),
                                    s("mark", ["onload", a()], null, "api");
                                var r = u.createElement("script");
                                (r.src = y.proto + t.agent),
                    ...
                    u[d]
                        ? (u[d]("DOMContentLoaded", i, !1), f[d]("load", r, !1))
                        : (u[l]("onreadystatechange", o), f[l]("onload", r)),
                        s("mark", ["firstbyte", a()], null, "api");
                    var g = 0;
                },
                {},
            ],
...
NREUM.info = {
    beacon: "bam.nr-data.net",
    errorBeacon: "bam.nr-data.net",
    licenseKey: "eb3c1c3bd9",
    applicationID: "30095121",
    sa: 1,
};
